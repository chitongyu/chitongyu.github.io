 ...
 * @LastEditTime: 2019-09-25 01:29:19
 * @Description: 
 -->
<template>
  <div class="myPrincipalTask w100 h100 flex column">
    ...
    <div class="flex_row_start padding-left4 margin-top1 no_shrink" ref="header1">
      <div class="poi activeTask" @click="$replaceTo('/task/myPrincipalTask?taskStatus=')" >指派给我的任务</div>
      <div class="margin-left4 poi"  @click="$replaceTo('/task/myCreateTask?taskStatus=')" >我创建的任务</div>
    </div>
    <div class="task-status  padding2 padding-left4  flex_row_between no_shrink"  ref="header2">
    ...
    <div v-loading="loading" class="myPrincipalTask-table bg_white  margin-left4 margin-right4">
      <CommonTable
        v-if="maxHeight"
        :tableData="myPrincipalTaskList"
    ...
    getMyPrincipalTaskByPage() {
        ...
        self.$http.post(
            ...
            function (suc) {
                ...
                self.myPrincipalTaskList.forEach((element)=>{
                  element.level=1;
                  if(element.isLeaf!=1){
