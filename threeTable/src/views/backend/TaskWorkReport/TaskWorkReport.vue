 ...
 * @LastEditTime: 2019-09-23 15:13:53
 * @Description: 
 -->
<template>
  <!-- 任务报工记录报表 -->
  <div
    class="TaskWorkReport w100 h100 flex column"
    v-loading="loading"
  >
    <NoPerimission v-if="!btPermissions['/backend/taskWorkReport']" />
  <template v-else>
        ...
        >
          ...
          <el-col :span="1.5">
            <el-button
              ...
              size="small"
              type="primary"
              v-show="btPermissions['/backend/taskWorkReport/select']"
            >搜索</el-button>
          </el-col>
          <el-col :span="1.5">
            <el-button
          ...
          <el-col :span="1.5">
            <el-button
              ...
              size="small"
              type="primary"
              v-show="btPermissions['/backend/taskWorkReport/export']"
            >导出搜索内容</el-button>
          </el-col>
        </el-col>
      </el-row>
...
export default {
    ...
    data() {
        return {
            searchObj: { //请求参数对象
                ...
                deptName: '',//部门名称
                groupName: '',//班组名称
                startCreateTime: '',//开始，报工日期
                endCreateTime: '',//完成，报工日期
                // token: ''
            },
            projectName: '',//项目名称
            projectNumber: '',//项目编号
    ...
    methods: {
        ...
        getAdminList() {
            ...
            self.$http.post(
                "/admin/report/taskWorkReportByPage.d",
                self.searchObj,
                function (suc) {
        ...
        exportExcel() {
          ...
          console.log(self.searchObj);
          let url= "/admin/report/taskWorkReportExport.d?deptName="+self.searchObj.deptName+
